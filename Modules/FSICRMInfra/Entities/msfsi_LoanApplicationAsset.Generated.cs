...
namespace Microsoft.CloudForFSI.Tables
{
	...
	public enum msfsi_LoanApplicationAssetState
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContractAttribute()]
	[Microsoft.Xrm.Sdk.Client.EntityLogicalNameAttribute("msfsi_loanapplicationasset")]
	public partial class msfsi_LoanApplicationAsset : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public msfsi_LoanApplicationAsset() : 
				base(EntityLogicalName)
		{
		}
		
		public const string EntityLogicalName = "msfsi_loanapplicationasset";
		
		public const string EntitySchemaName = "msfsi_LoanApplicationAsset";
		
		public const string PrimaryIdAttribute = "msfsi_loanapplicationassetid";
		
		public const string PrimaryNameAttribute = "msfsi_name";
		
		public const string EntityLogicalCollectionName = "msfsi_loanapplicationassets";
		
		public const string EntitySetName = "msfsi_loanapplicationassets";
		...
		/// <summary>
		/// Financial assets in a loan transaction. Assets may be either liquid or fixed and are associated with a corresponding asset amount
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msfsi_assettype")]
		public virtual msfsi_LoanApplicationAsset_msfsi_AssetType? msfsi_AssetType
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((msfsi_LoanApplicationAsset_msfsi_AssetType?)(EntityOptionSetEnum.GetEnum(this, "msfsi_assettype")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("msfsi_AssetType");
				this.SetAttributeValue("msfsi_assettype", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
		...
		/// <summary>
		/// The city for the primary address of this realted to this loan application asset.
		/// </summary>
		...
		/// <summary>
		/// The country or region for the primary address related to this loan application asset.
		/// </summary>
		...
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msfsi_loanapplicationassetid")]
		public System.Nullable<System.Guid> msfsi_LoanApplicationAssetId
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<System.Guid>>("msfsi_loanapplicationassetid");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("msfsi_LoanApplicationAssetId");
				this.SetAttributeValue("msfsi_loanapplicationassetid", value);
				if (value.HasValue)
				{
					base.Id = value.Value;
				}
				...
				this.OnPropertyChanged("msfsi_LoanApplicationAssetId");
			}
		}
		...
		public override System.Guid Id
		{
			...
			set
			{
				this.msfsi_LoanApplicationAssetId = value;
			}
		}
		...
		/// <summary>
		/// The cash or market value, net worth, face value or vested interest amount of the asset type. 
		/// </summary>
		...
		public System.Nullable<msfsi_LoanApplicationAssetState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((msfsi_LoanApplicationAssetState)(System.Enum.ToObject(typeof(msfsi_LoanApplicationAssetState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public virtual msfsi_LoanApplicationAsset_StatusCode? StatusCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((msfsi_LoanApplicationAsset_StatusCode?)(EntityOptionSetEnum.GetEnum(this, "statuscode")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		/// <summary>
		/// 1:N msfsi_LoanAppContactAsset_LoanAppAsset
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("msfsi_LoanAppContactAsset_LoanAppAsset")]
		public System.Collections.Generic.IEnumerable<msfsi_LoanApplicationContactAsset> msfsi_LoanAppContactAsset_LoanAppAsset
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<msfsi_LoanApplicationContactAsset>("msfsi_LoanAppContactAsset_LoanAppAsset", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("msfsi_LoanAppContactAsset_LoanAppAsset");
				this.SetRelatedEntities<msfsi_LoanApplicationContactAsset>("msfsi_LoanAppContactAsset_LoanAppAsset", null, value);
				this.OnPropertyChanged("msfsi_LoanAppContactAsset_LoanAppAsset");
			}
		}
		
		/// <summary>
		/// N:1 msfsi_LoanApplicationAsset_Bank_msfsi_bank
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msfsi_bank")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("msfsi_LoanApplicationAsset_Bank_msfsi_bank")]
		public msfsi_bank msfsi_LoanApplicationAsset_Bank_msfsi_bank
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<msfsi_bank>("msfsi_LoanApplicationAsset_Bank_msfsi_bank", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("msfsi_LoanApplicationAsset_Bank_msfsi_bank");
				this.SetRelatedEntity<msfsi_bank>("msfsi_LoanApplicationAsset_Bank_msfsi_bank", null, value);
				this.OnPropertyChanged("msfsi_LoanApplicationAsset_Bank_msfsi_bank");
			}
		}
		
		/// <summary>
		/// N:1 msfsi_LoanApplicationAsset_LoanApplication
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("msfsi_loanapplication")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("msfsi_LoanApplicationAsset_LoanApplication")]
		public msfsi_LoanApplication msfsi_LoanApplicationAsset_LoanApplication
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<msfsi_LoanApplication>("msfsi_LoanApplicationAsset_LoanApplication", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("msfsi_LoanApplicationAsset_LoanApplication");
				this.SetRelatedEntity<msfsi_LoanApplication>("msfsi_LoanApplicationAsset_LoanApplication", null, value);
		...
		/// </summary>
		[System.Diagnostics.DebuggerNonUserCode()]
		public msfsi_LoanApplicationAsset(object anonymousType) : 
				this()
		{
            foreach (var p in anonymousType.GetType().GetProperties())
            {
                ...
                switch (name)
                {
                    case "id":
                        ...
                        Attributes["msfsi_loanapplicationassetid"] = base.Id;
                        break;
                    case "msfsi_loanapplicationassetid":
