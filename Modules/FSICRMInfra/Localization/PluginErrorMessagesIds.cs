namespace Microsoft.CloudForFSI.ErrorMessages.Localization
{
    ...
    internal static partial class PluginErrorMessagesIds
    {
        public static class Infra
        {
            ...
            public static readonly string MissingMappingDataInCi = "MissingMappingDataInCi";
            ...
            public static readonly string MissingConfigurationInChurnConfig = "MissingConfigurationInChurnConfig";
            public static readonly string ParsingFailedForChurnLevel = "ParsingFailedForChurnLevel";
            ...
            public static readonly string CiDataSourceAcquireFailed = "CiDataSourceAcquireFailed";
            public static readonly string CiEntityNameNullOrEmpty = "CiEntityNameNullOrEmpty";
            ...
            public static readonly string CiCustomerIdWasNotFound = "CiCustomerIdWasNotFound";
