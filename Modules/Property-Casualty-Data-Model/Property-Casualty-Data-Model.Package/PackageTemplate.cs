...
namespace PropertyCasualtyDataModel.Package
{
    ...
    using Microsoft.CloudForFSI.Infra.PackageDeployer;
    ...
    public class PackageTemplate : ImportExtension
    {
        ...
        {
            this.DataImportBypass = ConfigDataService.skipConfigData(this.RuntimeSettings, this.PackageLog);
        }

        /// <summary>
        /// Called to decide what language of data file should be used to import.
        /// </summary>
        ...
        {
            this._lcid = LCIDService.SupportLocal(selectedLanguage, availableLanguages, this.RuntimeSettings, this.PackageLog, this.CrmSvc);
            return base.OverrideConfigurationDataFileLanguage(this._lcid, availableLanguages);
        }
        ...
        public override string GetImportPackageDataFolderName
        {
            get
            {
                ...
                return "Property-Casualty-Data-Model";
            }
        }
