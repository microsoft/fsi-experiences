...
describe('FinancialGroupedTable', () => {
    const itemsFirstGroup = [
        { id: '1', name: 'some name 1', typeFormattedValue: 'type 1', description: 'description 1', value: 50, category: CATEGORIES.INCOME },
    ...
    it('Should render FinancialGroupedTable - Empty State', () => {
        const { getByText } = render(<FinancialGroupedTable groups={undefined as any} data={undefined as any} actionsRenderer={jest.fn()} />);
