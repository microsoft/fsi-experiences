...
import type { IFinancialGroupedTableProps } from './FinancialGroupedTable.interface';
import { typeField, actionsField, descriptionField, valueField } from './FinancialGroupedTable.const';
...
export const FinancialGroupedTable: FC<IFinancialGroupedTableProps> = ({
    ...
    /* istanbul ignore next */
    if (!data || !data.length) {
        return <EmptyState icon={IMAGE_SRC.emptyState} iconSize={200} title={translate('EMPTY_STATE_TABLE_INCOME_AND_EXPENSES')} />;
    }
