...
export const getCombinedTextStyles = (isRegularFontWeight?: boolean) => {
    return mergeStyleSets(textStyles, {
        root: { fontWeight: isRegularFontWeight ? FontWeights.regular : FontWeights.semibold },
    });
};
