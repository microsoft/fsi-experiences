...
import RemoveLoanFinancialItemDialog from './RemoveLoanFinancialItemDialog';
...
const ProvidedLoanFinancialItemRemoveFormDialog = ProviderWrapper(RemoveLoanFinancialItemDialog);

describe('RemoveLoanFinancialItemDialog', () => {
    const mockProps = {
        onSubmit: jest.fn(),
        onCancel: jest.fn(),
    ...
    it('should render category list after loading', () => {
        const { container } = render(<ProvidedLoanFinancialItemRemoveFormDialog {...mockProps} />);

        expect(container).toBeInTheDocument();
    });

    it('should not render if item is not valid', () => {
        const { container } = render(<ProvidedLoanFinancialItemRemoveFormDialog {...mockProps} item={null as any} />);
    ...
    it('should call `onSubmit` function', async () => {
        ...
        const { getByTestId } = render(<ProvidedLoanFinancialItemRemoveFormDialog {...customProps} />);
