...
const primaryApplicantID = mockLoanCustomers[0].id;
const borrowerID = mockLoanCustomers[1].id;
...
export const applicantsDataMock = { applicants: mockLoanCustomers, primaryApplicantId: mockLoanCustomers[0].id };
