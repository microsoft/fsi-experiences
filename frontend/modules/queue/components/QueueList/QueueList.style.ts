...
const queueListClassPrefix = 'queue-list';

export const getClassNames = (customStyles?: IQueueListStyles): IQueueListStyles => {
    return mergeStyleSets(
        {
            queueListWrapper: {
                displayName: `${queueListClassPrefix}__wrapper`,
            ...
            queueList: {
                displayName: queueListClassPrefix,
            ...
            queueListGroupHeader: {
                displayName: `${queueListClassPrefix}__group-header`,
                display: 'flex',
                minWidth: 0,
                width: '100%',
            ...
            queueListGroupHeaderPrimaryText: {
                displayName: `${queueListClassPrefix}__group-header-primary-text`,
                minWidth: 0,
                paddingInlineStart: '11px',
            },
            queueListGroupHeaderSecondaryText: {
                displayName: `${queueListClassPrefix}__group-header-secondary-text`,
                alignSelf: 'center',
                minWidth: 0,
