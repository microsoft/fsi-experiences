...
import { getReactElement, init, loadImages } from '@fsi/pcf-common/dist/life-cycle';
import { CustomerSnapshotContainer } from '@fsi/pcf-common/dist/containers/CustomerSnapshot/CustomerSnapshotContainer';

// @ts-ignore
export class EntitySnapshotControl implements VirtualControl<IInputs, IOutputs> {
    /**
     * Empty constructor.
     */
    constructor() {}
    ...
    public async init(context, notifyOutputChanged: () => void, state: ComponentFramework.Dictionary, container: HTMLDivElement) {
        init(context, 'MicrosoftPCF.EntitySnapshotControl');
    ...
    public updateView(context): React.ReactElement {
        return getReactElement(CustomerSnapshotContainer, { context, linkToEntityField: context.parameters.linkToEntityField?.raw });
    }
