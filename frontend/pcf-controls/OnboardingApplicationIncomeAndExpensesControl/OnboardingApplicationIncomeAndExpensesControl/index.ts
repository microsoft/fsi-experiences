...
import OnboardingApplicationIncomeAndExpensesWidgetContainer from './container/OnboardingApplicationIncomeAndExpensesWidget';
import OnboardingApplicationIncomeAndExpensesGridContainer from './container/OnboardingApplicationIncomeAndExpensesGridContainer';

const componentEnumToComponent = {
    '0': OnboardingApplicationIncomeAndExpensesGridContainer,
    '1': OnboardingApplicationIncomeAndExpensesWidgetContainer,
};

// @ts-ignore
export class OnboardingApplicationIncomeAndExpensesControl implements VirtualControl<IInputs, IOutputs> {
    ...
    public async init(context, notifyOutputChanged: () => void, state: ComponentFramework.Dictionary, container: HTMLDivElement) {
        init(context, 'MicrosoftPCF.OnboardingApplicationIncomeAndExpensesControl');
        loadImages(context, ['emptyState', 'error100']);
